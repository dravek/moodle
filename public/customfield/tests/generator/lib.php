...
class core_customfield_generator extends component_generator_base {
    ...
    public function create_category($record = null) {
        ...
        $cats = $handler->get_categories_with_fields();
        return $handler->get_category_from_array($cats, $categoryid, $handler->get_component(), $handler->get_area(),
            $handler->get_itemid());
    }
    ...
    public function create_field($record): field_controller {
        ...
        $category = $handler->get_category_from_array($categories, $field->get('categoryid'), $handler->get_component(),
