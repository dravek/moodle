...
final class api_test extends \advanced_testcase {
    ...
    public function test_create_category(): void {
        ...
        $c1 = $handler->get_category_from_array($categories, $c1id, $handler->get_component(),
        ...
        $categories = $handler->get_categories_with_fields();
        $c2 = $handler->get_category_from_array($categories, $c2id, $handler->get_component(),
            $handler->get_area(), $handler->get_itemid());
        $c3 = $handler->get_category_from_array($categories, $c3id, $handler->get_component(),
            $handler->get_area(), $handler->get_itemid());
