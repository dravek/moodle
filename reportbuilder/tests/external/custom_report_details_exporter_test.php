...
final class custom_report_details_exporter_test extends advanced_testcase {
    ...
    public function test_export(): void {
        ...
        $this->assertEquals('customfield name', $export->customfields[0]['name']);
        $this->assertEquals('fld1', $export->customfields[0]['shortname']);
        $this->assertEquals('Hello123', $export->customfields[0]['value']);
