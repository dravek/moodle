...
class duplicate_report extends dynamic_form {
    ...
    public function definition() {
        ...
        $mform->setDefault('name', $this->optional_param('name', 0, PARAM_TEXT));
    ...
    protected function get_context_for_dynamic_submission(): context {
        $report = manager::get_report_from_id($this->optional_param('id', 0, PARAM_INT));
    ...
    protected function check_access_for_dynamic_submission(): void {
        $report = manager::get_report_from_id($this->optional_param('id', 0, PARAM_INT));
        permission::require_can_duplicate_report($report->get_report_persistent());
    }
